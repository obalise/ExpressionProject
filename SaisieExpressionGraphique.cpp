...
#include "ui_SaisieExpressionGraphique.h"

NewMainWindow *newWin2 = 0; //utilisé pour créé une nouvelle fenêtre

SaisieExpressionGraphique::SaisieExpressionGraphique(QWidget *parent)
    : QMainWindow(parent)
...
SaisieExpressionGraphique::~SaisieExpressionGraphique()
{
    delete ui;
}


void SaisieExpressionGraphique::on_pushButton_clicked()   //Constante
{
...
void SaisieExpressionGraphique::on_pushButton_6_clicked() //Variable
{
...
void SaisieExpressionGraphique::on_pushButton_2_clicked() //Addition
{
...
void SaisieExpressionGraphique::on_pushButton_4_clicked() //Soustraction
{
    Expression *pOperande2 = pileExpression.top();
    pileExpression.pop();
    Expression *pOperande1 = pileExpression.top();
...
void SaisieExpressionGraphique::on_pushButton_3_clicked() //Multiplication
{
    Expression *pOperande2 = pileExpression.top();
    pileExpression.pop();
    Expression *pOperande1 = pileExpression.top();
...
void SaisieExpressionGraphique::on_pushButton_5_clicked() //Division
{
    Expression *pOperande2 = pileExpression.top();
    pileExpression.pop();
    Expression *pOperande1 = pileExpression.top();
...
void SaisieExpressionGraphique::on_pushButton_7_clicked() //Tracer le graphe
{
    Expression* expression = pileExpression.top();
    ...
    newWin2 = new NewMainWindow();
    newWin2->setCentralWidget(florent);
    newWin2->resize(400, 300);
    newWin2->show();
...
void SaisieExpressionGraphique::on_doubleSpinBox_valueChanged(double arg1) //Pas
{
    _nombrePasSaisie = arg1;
}


void SaisieExpressionGraphique::on_doubleSpinBox_2_valueChanged(double arg1) //Minimum
{
    _nombrePlageBasseSaisie = arg1;
}


void SaisieExpressionGraphique::on_doubleSpinBox_3_valueChanged(double arg1) //Maximum
{
    _nombrePlageHauteSaisie = arg1;
}


void SaisieExpressionGraphique::on_doubleSpinBox_4_valueChanged(double arg1) //Constante
{
